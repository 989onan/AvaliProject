...
public class MizoleRenderer<R extends EntityRenderState & GeoRenderState> extends GeoEntityRenderer<MizoleEntity, R> {
    ...
    @Override
    public void addRenderData(MizoleEntity animatable, Void relatedObject, R renderState) {
