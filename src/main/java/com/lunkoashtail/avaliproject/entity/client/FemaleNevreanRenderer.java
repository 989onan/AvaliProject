...
public class FemaleNevreanRenderer<R extends EntityRenderState & GeoRenderState> extends GeoEntityRenderer<FemaleNevreanEntity, R> {
    ...
    @Override
    public void addRenderData(FemaleNevreanEntity animatable, Void relatedObject, R renderState) {
