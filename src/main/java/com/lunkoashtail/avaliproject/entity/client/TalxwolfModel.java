...
public class TalxwolfModel extends GeoModel<TalxwolfEntity> {
    ...
    public ResourceLocation getTextureResource(GeoRenderState entity) {
        return ResourceLocation.parse("avaliproject:textures/entity/talxwolf/" + entity.getGeckolibData(texture) + ".png");
    }

    @Override
    public void setCustomAnimations(AnimationState<TalxwolfEntity> animatable) {
