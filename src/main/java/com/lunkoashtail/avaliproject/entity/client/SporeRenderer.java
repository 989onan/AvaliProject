...
public class SporeRenderer<R extends EntityRenderState & GeoRenderState>  extends GeoEntityRenderer<SporeEntity, R> {
    ...
    @Override
    public void addRenderData(SporeEntity animatable, Void relatedObject, R renderState) {
