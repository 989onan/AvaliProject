...
public class TalxwolfRenderer<R extends EntityRenderState & GeoRenderState>  extends GeoEntityRenderer<TalxwolfEntity, R> {
    ...
    @Override
    public void addRenderData(TalxwolfEntity animatable, Void relatedObject, R renderState) {
