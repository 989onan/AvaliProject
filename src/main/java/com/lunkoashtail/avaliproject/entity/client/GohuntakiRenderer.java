...
public class GohuntakiRenderer<R extends EntityRenderState & GeoRenderState> extends GeoEntityRenderer<GohuntakiEntity, R> {
    ...
    @Override
    public void addRenderData(GohuntakiEntity animatable, Void relatedObject, R renderState) {
