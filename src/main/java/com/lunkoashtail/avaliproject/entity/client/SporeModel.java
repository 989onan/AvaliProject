...
public class SporeModel extends GeoModel<SporeEntity> {
    ...
    public ResourceLocation getTextureResource(GeoRenderState entity) {
        return ResourceLocation.parse("avaliproject:textures/entity/spore/" + entity.getGeckolibData(texture) + ".png");
    }

    @Override
    public void setCustomAnimations(AnimationState<SporeEntity> animatable) {
