...
public class TalxdogRenderer<R extends EntityRenderState & GeoRenderState>  extends GeoEntityRenderer<TalxdogEntity, R> {
    ...
    @Override
    public void addRenderData(TalxdogEntity animatable, Void relatedObject, R renderState) {
