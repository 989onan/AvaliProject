...
public class TalxdogEntity extends TamableAnimal implements GeoEntity {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        TalxdogEntity retval = ModEntities.TALXDOG.get().create(serverWorld, EntitySpawnReason.BREEDING);
    ...
    private PlayState movementPredicate(AnimationTest<TalxdogEntity> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<TalxdogEntity> event) {
