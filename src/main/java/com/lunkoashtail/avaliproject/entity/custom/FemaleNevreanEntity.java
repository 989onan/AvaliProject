...
public class FemaleNevreanEntity extends Animal implements GeoEntity {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        FemaleNevreanEntity retval = ModEntities.FEMALE_NEVREAN.get().create(serverWorld, EntitySpawnReason.BREEDING);
    ...
    private PlayState movementPredicate(AnimationTest<FemaleNevreanEntity> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<FemaleNevreanEntity> event) {
