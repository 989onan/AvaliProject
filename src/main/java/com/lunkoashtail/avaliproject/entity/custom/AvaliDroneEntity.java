...
public class AvaliDroneEntity extends TamableAnimal implements RangedAttackMob, GeoEntity {
    ...
    protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
        ...
        this.spawnAtLocation(serverLevel, new ItemStack(Items.IRON_INGOT, 6));
    }
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        InteractionResult retval = this.level().isClientSide() ? InteractionResult.SUCCESS: InteractionResult.PASS;
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        AvaliDroneEntity retval = ModEntities.AVALI_DRONE.get().create(serverWorld,EntitySpawnReason.BREEDING);
    ...
    private PlayState movementPredicate(AnimationTest<AvaliDroneEntity> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<AvaliDroneEntity> event) {
