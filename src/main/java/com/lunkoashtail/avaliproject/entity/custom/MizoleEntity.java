...
public class MizoleEntity extends TamableAnimal implements GeoEntity {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        MizoleEntity retval = ModEntities.MIZOLE.get().create(serverWorld, EntitySpawnReason.BREEDING);
    ...
    private PlayState movementPredicate(AnimationTest<MizoleEntity> event) {
    ...
    private PlayState attackingPredicate(AnimationTest<MizoleEntity> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<MizoleEntity> event) {
