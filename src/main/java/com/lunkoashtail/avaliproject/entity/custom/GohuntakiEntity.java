...
public class GohuntakiEntity extends TamableAnimal implements GeoEntity {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        GohuntakiEntity retval = ModEntities.GOHUNTAKI.get().create(serverWorld, EntitySpawnReason.BREEDING);
    ...
    private PlayState movementPredicate(AnimationTest<GohuntakiEntity> event) {
    ...
    private PlayState attackingPredicate(AnimationTest<GohuntakiEntity> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<GohuntakiEntity> event) {
