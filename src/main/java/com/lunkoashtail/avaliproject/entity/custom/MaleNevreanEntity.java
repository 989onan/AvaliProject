...
public class MaleNevreanEntity extends Animal implements GeoEntity {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        MaleNevreanEntity retval = ModEntities.MALE_NEVREAN.get().create(serverWorld, EntitySpawnReason.BREEDING);
    ...
    private PlayState movementPredicate(AnimationTest<MaleNevreanEntity> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<MaleNevreanEntity> event) {
