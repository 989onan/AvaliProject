...
public class SksceegehkjaEntity extends TamableAnimal implements GeoEntity {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        SksceegehkjaEntity retval = ModEntities.SKSCEEGEHKJA.get().create(serverWorld,EntitySpawnReason.BREEDING);
    ...
    private PlayState movementPredicate(AnimationTest<SksceegehkjaEntity> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<SksceegehkjaEntity> event) {
