...
public class SporeEntity extends TamableAnimal implements GeoEntity {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        SporeEntity retval = ModEntities.SPORE.get().create(serverWorld, EntitySpawnReason.BREEDING);
    ...
    private PlayState movementPredicate(AnimationTest<SporeEntity> event) {
    ...
    private PlayState attackingPredicate(AnimationTest<SporeEntity> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<SporeEntity> event) {
