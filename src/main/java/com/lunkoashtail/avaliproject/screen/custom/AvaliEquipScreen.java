...
public class AvaliEquipScreen extends AbstractContainerScreen<AvaliEquipMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(AvaliProject.MOD_ID, "textures/gui/avali_equip/avali_equip_gui.png");
    private static final float REFERENCE_WIDTH = 400f;
    private static final float REFERENCE_HEIGHT = 320f;
    private static final float MIN_SCALE = 0.5f;
    private static final float MAX_SCALE = 2.0f;

    public AvaliEquipScreen(AvaliEquipMenu menu, Inventory playerInventory, Component title) {
    ...
    public void render(GuiGraphics gfx, int mouseX, int mouseY, float partialTick) {
        ...
        renderAvaliModel(gfx, mouseX, mouseY, scale);
    }

    private void renderAvaliModel(GuiGraphics gfx, int mouseX, int mouseY, float scale) {
        ...
        InventoryScreen.renderEntityInInventoryFollowsMouse(
                ...
                Math.round(30 * scale), 0.0f, (float) mouseX, (float) mouseY, this.menu.avali);
    }
