...
public class QrcItem extends Item implements GeoItem {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private QrcItemRenderer renderer;

            @Override
            public @Nullable GeoItemRenderer<QrcItem> getGeoItemRenderer() {
                if (this.renderer == null)
                    this.renderer = new QrcItemRenderer();
                return this.renderer;
            }
        });
    }

    private PlayState idlePredicate(AnimationTest<QrcItem> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<QrcItem> event) {
