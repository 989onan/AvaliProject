...
public class FirelanceItem extends Item implements GeoItem {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private FirelanceItemRenderer renderer;

            @Override
            public @Nullable GeoItemRenderer<FirelanceItem> getGeoItemRenderer() {
                if (this.renderer == null)
                    this.renderer = new FirelanceItemRenderer();
                return this.renderer;
            }
        });
    }

    private PlayState idlePredicate(AnimationTest<FirelanceItem> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<FirelanceItem> event) {
    ...
    public InteractionResult use(Level world, Player entity, InteractionHand hand) {
        ...
        CustomProjectileEvent.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
        return ar;
    }
}