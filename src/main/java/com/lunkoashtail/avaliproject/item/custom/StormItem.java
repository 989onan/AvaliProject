...
public class StormItem extends Item implements GeoItem {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private StormItemRenderer renderer;

            @Override
            public @Nullable GeoItemRenderer<StormItem> getGeoItemRenderer() {
                if (this.renderer == null)
                    this.renderer = new StormItemRenderer();
                return this.renderer;
            }
        });
    }

    private PlayState idlePredicate(AnimationTest<StormItem> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<StormItem> event) {
    ...
    public InteractionResult use(Level world, Player entity, InteractionHand hand) {
        ...
        PistolProjectileEvent.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
        return ar;
    }
}