...
public class MlseriesItem extends Item implements GeoItem {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            ...
            @Override
            public @Nullable GeoItemRenderer<MlseriesItem> getGeoItemRenderer() {
    ...
    private PlayState idlePredicate(AnimationTest<MlseriesItem> event) {
    ...
    private PlayState procedurePredicate(AnimationTest<MlseriesItem> event) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar data) {
        AnimationController<MlseriesItem> procedureController = new AnimationController<>("procedureController", 0, this::procedurePredicate);
        data.add(procedureController);
        AnimationController<MlseriesItem> idleController = new AnimationController<>("idleController", 0, this::idlePredicate);
    ...
    public InteractionResult use(Level world, Player entity, InteractionHand hand) {
        ...
        ExplosiveProjectileEvent.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
        return ar;
    }
}